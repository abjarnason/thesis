...
\\ \\
WebSocket substantially simplifies the development of applications with real-time functionality compared to previous approaches. The main obstacle towards greater adoption of WebSocket is the current infrastructure of the Internet that is predominantly configured for HTTP traffic and tends to block any traffic that behaves differently. Increased usage of HTTP/2 will most likely benefit WebSocket as it requires networks intermediaries to be configured for long-lived connections. A challenge when using containerized virtualization for run-time environments of WebSocket applications is that there are usually more intermediaries that require special configuration. This thesis is seen as a starting point for further development of the WebSocket messaging system and an opportunity to establish a better understanding of operational challenges related to WebSocket-based infrastructure.}
