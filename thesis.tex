...
\\ \\
The results from this thesis are seen as a starting point for further development of the WebSocket messaging system and an opportunity to get a better understanding of operational challenges related to WebSocket-based infrastructure. The results presented in this thesis are general and can be applied to similar use cases}
